...
function bot_ui_ini() {
    ...
    var sure = function() {
        ...
        botui.message.add({
            ...
            botui.message.add({
                delay: 1500,
                content: "是主修国际贸易,辅修软工的程序猿~"
            }).then(function() {
                botui.message.add({
                    delay: 1200,
                    content: "但是将敲代码看成一种快乐"
                }).then(function() {
                    botui.message.add({
                        delay: 1500,
                        content: "主修 Java 和 Scala,略知 linux,偶尔也搞 HTML/CSS/JavaScript"
                    }).then(function() {
                        botui.message.add({
                            delay: 1500,
                            content: "自学了，大数据(BigData)"
                        }).then(function() {
                            botui.message.add({
                                delay: 1800,
                                content: "喜欢看动漫和玩手游"
